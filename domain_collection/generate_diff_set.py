...
with open("domain_sources/Tranco_Worldwide_20_November_2020/top-1m.csv", 'r') as fd:
    for line in fd:
...
with open("domain_sources/Tranco_Europe_22_November_2020/tranco_WNJ9.csv", 'r') as fd:
    for line in fd:
